// app/couriers/deppon-express-logistics/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "deppon-express-logistics",
  name: "Deppon Express Logistics shipment",
  website: "https://www.deppon.com/",
  city: "Shanghai",
  address: "No. 1018, Mingzhu Road, Xujing Town, Qingpu District, Shanghai",
  phone_numbers: ["+86 95353"],
  emails: ["kehutiyanzhichizu@deppon.com"],
  logo: "",
};
...
export default function DepponExpressLogisticsPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/couriers/npct1-courier-indonesia"
              className="text-blue-600 underline"
            >
              NPCT1 Courier Delivery
            </Link>
          </span>
        </p>
      </section>
