// app/couriers/leopards-china-express/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "leopards-china-express",
  name: "Leopards Express Courier Delivery",
  website: "http://www.leopardschina.com/",
  city: "Hang Zhou",
  address: "Hang Zhou, China",
  phone_numbers: ["+86 400-668-1818"],
  emails: ["john@leopardschina.com"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Hang Zhou, China. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Hang Zhou, China.`,
...
export default function LeopardsChinaExpressPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/abk-logistics-courier"
              className="text-blue-600 underline"
            >
              ABK Logistics Courier
            </Link>
          </span>
        </p>
      </section>
