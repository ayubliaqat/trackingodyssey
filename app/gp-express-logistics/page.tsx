// app/couriers/gp-express-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "gp-express-tracking",
  name: "GP Express Logistics",
  website: "https://gpexpress.net/",
  city: "Abu Dhabi",
  address: "Shop No. 4 Building 87, Sabiyah 10, Mussaffah (Opp. Al Noor Hospital)",
  phone_numbers: ["056 618 8856"],
  emails: ["gp-express-logistics"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `Check your parcel status with ${courier.name} in Abu Dhabi, UAE.`,
...
export default function GPExpressPage() {
  return (
      ...
      {courier.website && (
        <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
          ...
          <p className="text-gray-700 break-words">
            ...
            <Link href="/ana-cargo-flight" className="text-blue-600 underline">
              Ana Cargo Shipment
            </Link>
          </p>
        </section>
