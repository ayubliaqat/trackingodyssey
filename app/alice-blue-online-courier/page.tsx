// app/couriers/alice-blue-online-courier/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "alice-blue-online-courier",
  name: "Alice Blue Online Shipment Deliver",
  website: "https://aliceblueonline.com/",
  city: "Bengaluru",
  address:
    "No. 153/2, 3rd Floor, M.R.B.Arcade, Bagalur Main Road, Dwaraka Nagar, Yelahanka, Bengaluru – 560 063",
  phone_numbers: ["+91 76764 44362"],
  emails: ["askus@aliceblueindia.com"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in ${courier.city}. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in ${courier.city}.`,
...
export default function AliceBlueOnlineCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/couriers/deppon-express-logistics"
              className="text-blue-600 underline"
            >
              Deppon Express Logistics shipment
            </Link>
          </span>
        </p>
      </section>
