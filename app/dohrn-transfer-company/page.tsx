// app/couriers/dohrn-transfer-company/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "dohrn-transfer-company",
  name: "Dohrn Order Delivery",
  website: "https://www.dohrn.com/",
  city: "Rock Island",
  address: "625 3rd Avenue, Rock Island, IL 61201",
  phone_numbers: ["1-800-747-3507"],
  emails: ["customerservice@dohrn.com"],
  logo: "",
};
...
export default function DohrnTransferCompanyPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/couriers/blpl-singapore-courier"
              className="text-blue-600 underline"
            >
              BLPL Courier Delivery
            </Link>
          </span>
        </p>
      </section>
