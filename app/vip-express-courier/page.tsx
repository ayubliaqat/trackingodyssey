// app/couriers/vip-express-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "vip-express-courier",
  name: "VIP Express Order shipment",
  website: "https://vipexpressww.com/",
  city: "Hayes, Middlesex",
  address: "Unit 2, Adler Industrial Est. Betam Road, Hayes Middlesex UB3 1ST",
  phone_numbers: ["+44 (0)20 8569 1038"],
  emails: ["info@vipexpressww.com", "sales@vipexpressww.com"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Hayes, Middlesex. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Hayes, Middlesex, UK.`,
...
export default function VIPExpressPage() {
  return (
      ...
      {courier.website && (
        ...
        >
          ...
          <p className="text-gray-700">
            ...
            <span className="mr-2">
              <Link href="/kgp-express-courier" className="text-blue-600 underline">
                KGP Express Courier Shipment
              </Link>
            </span>
          </p>
        </section>
