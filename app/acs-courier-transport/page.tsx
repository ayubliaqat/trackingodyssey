// app/couriers/acs-courier-transport/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "acs-courier-transport",
  name: "ACS Transport Order Shipment",
  website: "https://www.acscourier.net/",
  city: "Egaleo",
  address: "36-38 Petrou Ralli Str 122 41, Egaleo, Attica, Greece",
  phone_numbers: ["+30 210 81 90 000"],
  emails: [],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Egaleo. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Egaleo, Greece.`,
...
export default function AcsCourierTransportPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/pandu-logistics-courier"
              className="text-blue-600 underline"
            >
              Pandu Logistics Delivery Status
            </Link>
          </span>
        </p>
      </section>
