// app/couriers/post2u-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "post2u-tracking",
  name: "Post2U Courier Delivery",
  website: "https://www.post2u.com.my/index.html",
  city: "Subang Jaya",
  address:
    "14, Jalan Industri USJ 1/11, Taman Perindustrian Usj 1, 47600 Subang Jaya, Selangor, Malaysia",
  phone_numbers: ["+603-5892 1531"],
  emails: ["ask@post2u.com.my"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Subang Jaya. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Subang Jaya, Malaysia.`,
...
export default function Post2UPage() {
  return (
