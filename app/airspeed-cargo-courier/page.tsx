// app/couriers/airspeed-cargo-courier-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "airspeed-cargo-courier",
  name: "Airspeed Cargo Courier",
  website: "https://airspeed.ph/",
  city: "Manila",
  address: "GGB Building, Pascor Drive Parañaque City, Metro Manila",
  phone_numbers: ["(02) 8852-7328 to 37"],
  emails: ["info@airspeed.ph"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Manila. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Manila, Philippines.`,
...
export default function AirspeedPage() {
  return (
      ...
      {courier.website && (
        <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
          ...
          <p className="text-gray-700">
            ...
            <span className="mr-2">
              <Link href="/air-canada-cargo" className="text-blue-600 underline">
                Air Canada Cargo
              </Link>
            </span>
          </p>
