// app/roadrunner-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "roadrunner-tracking",
  name: "Roadrunner Freight Courier Delivery",
  website: "https://freight.rrts.com/",
  city: "Illinois",
  address: "1431 Opus Place Ste 530 Downers Grove, IL 60515",
  phone_numbers: ["(414) 615-1500"],
  emails: ["LTLcustomerservice@rrts.com"],
  logo: "",
};
...
export default function RoadrunnerTrackingPage() {
  return (
