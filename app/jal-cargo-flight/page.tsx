// app/couriers/jal-cargo-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "jal-cargo-flight",
  name: "Jal Cargo Shipment",
  website: "https://www.jal.co.jp/",
  city: "Sepang",
  address: "GFM0015 Mas Advance Cargo Centre Klia 64000 Sepang Selangor Malaysia",
  phone_numbers: ["603-8787-2223"],
  emails: [],
  logo: "",
};
...
export default function JalCargoPage() {
  return (
