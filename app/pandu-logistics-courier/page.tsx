// app/pandu-logistics-courier/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "pandu-logistics-courier",
  name: "Pandu Logistics Delivery Status",
  website: "https://pandulogistics.com/",
  city: "Jakarta",
  address:
    "Graha Pandu, Jl. Raya Bekasi Timur, KM 18, No 30. Jatinegara, Jakarta Timur 13930, Indonesia.",
  phone_numbers: ["+62-21 3000 9000"],
  emails: ["admin@pandulogistics.com"],
  logo: "",
};
...
export default function PanduLogisticsCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link href="/tccs-logistics" className="text-blue-600 underline">
              TCCS Parcel Delivery
            </Link>
          </span>
        </p>
      </section>
