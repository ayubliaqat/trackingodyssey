// app/couriers/lalamove-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "lalamove-delivery",
  name: "Lalamove Courier Delivery",
  website: "https://www.lalamove.com/ms-my/",
  city: "Kuala Lumpur",
  address:
    "200, Jalan Segambut, Segambut, 51200 Kuala Lumpur, Federal Territory of Kuala Lumpur",
  phone_numbers: ["+852 37013701"],
  emails: ["partner.support@lalamove.com"],
  logo: "",
};
      ...
      {courier.website && (
        ...
        >
          ...
          <p className="text-gray-700">
            ...
            <span className="mr-2">
              <Link href="/fgv-transport" className="text-blue-600 underline">
                FGV Transport Courier
              </Link>
            </span>
          </p>
        </section>
