// app/couriers/pd-express-logistics-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "pd-express-logistics-tracking",
  name: "PD Express Logistics",
  website: "https://pdexpress.in/",
  city: "Delhi",
  address: "Shop No. 37, Khosla Complex, Ground Floor, Gagan Vihar Extension, Delhi-110051",
  phone_numbers: ["+91-9911581968","+91-9810759046"],
  emails: ["admin@pdexpress.in"],
  logo: "",
};
...
export default function PDExpressPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link href="/couriers/neelgiri-tracking" className="text-blue-600 underline">
              Neelgiri Courier Delivery
            </Link>
          </span>
        </p>
      </section>
