// app/couriers/natbro-tracking/page.tsx
...
export const metadata: Metadata = {
  ...
  description: `Track your NATBRO Logistics shipments easily with real-time updates on your package status.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Harrow, England.`,
...
export default function NatbroPage() {
  return (
