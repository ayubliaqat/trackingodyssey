// app/couriers/shoponcliq-order-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "shoponcliq-order-tracking",
  name: "ShopOnCliQ Order Online",
  website: "https://shoponcliq.com/",
  city: "New Delhi",
  address: "28/132, Ground Floor, West Patel Nagar, New Delhi -110008",
  phone_numbers: ["9266887788"],
  emails: ["support@shoponcliq.com"],
  logo: "", // optional
};
...
export const metadata: Metadata = {
  ...
  description: `Track your ShopOnCliQ orders easily with real-time updates on your package status.`,
...
export default function ShopOnCliQPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link href="/couriers/natbro-tracking" className="text-blue-600 underline">NATBRO Logistics Service</Link>
          </span>
        </p>
      </section>
