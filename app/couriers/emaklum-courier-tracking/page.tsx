// app/couriers/emaklum-courier-tracking/page.tsx
...
const courier = {
  slug: "emaklum-courier-tracking",
  name: "Emaklum Courier Transport",
  website: "https://emaklum.anm.gov.my/",
  city: "Putrajaya",
  address: "Kompleks Kementerian Kewangan No. 1, Persiaran Perdana Presint 2, 62594 Putrajaya",
  phone_numbers: ["03-8872 3622", "03-8872 3618", "03-8872 3612"],
  emails: [],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Putrajaya. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Putrajaya, Malaysia.`,
...
export default function EmaklumCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/pioneer-express-logistics-tracking" className="text-blue-600 underline">
            Pioneer Express Logistics
          </Link>
        </p>
      </section>
