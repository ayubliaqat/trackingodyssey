// app/couriers/naranji-peraj-transport-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "naranji-peraj-transport-tracking",
  name: "Naranji Peraj Transport",
  website: "https://nptco.in/",
  city: "Mumbai",
  address: "B24/25 Satyam Shopping Centre, Mezzanine Floor, M.G Road, Ghatkopar (East), Mumbai 400077, India",
  phone_numbers: ["90760 11101", "90760 2220"],
  emails: ["infonptc@gmail.com", "info@nptco.in"],
  logo: "", // optional
};
...
export const metadata: Metadata = {
  ...
  description: `Track your Naranji Peraj Transport shipments easily with real-time updates on your package status.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Mumbai, India.`,
...
export default function NaranjiPerajPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <header className="flex flex-col items-center mb-8 text-center">
        ...
        <p className="text-base sm:text-lg text-gray-700 mt-8">
          Enter your tracking number to check your shipment status online.
        </p>
      </header>

      {/* Tracking Form */}
      <section aria-labelledby="tracking-form" className="text-center mb-8 mt-4">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span>
            <Link href="/couriers/banggood-order-delivery-tracking" className="text-blue-600 underline">
              Banggood Order Delivery Tracking
            </Link>
          </span>
        </p>
      </section>
