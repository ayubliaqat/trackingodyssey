// app/couriers/sagawa-courier-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "sagawa-courier-tracking",
  name: "Sagawa Express Courier",
  website: "https://www.sagawa-exp.co.jp/",
  city: "Kyoto",
  address: "68 Kamitobatsunoda-cho, Minami-ku, Kyoto 601-8104, Japan",
  phone_numbers: ["+81 0120-18-9595"],
  emails: [], // No emails provided
  logo: "", // optional
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Kyoto. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Kyoto, Japan.`,
...
export default function SagawaCourierPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/mahindra-tracking" className="text-blue-600 underline">
              Mahindra Logistics Courier
            </Link>
          </span>
