// app/couriers/shipmentlink-courier-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "shipmentlink-courier-tracking",
  name: "Shipmentlink Courier Transport",
  website: "https://bluedart.com/",
  city: "Ahmedabad",
  address: "Shalimar Co-Op Hsg Soc, Near Embassy Market, Off Ashram Road, Ahmedabad, Gujarat, India - 380008",
  phone_numbers: ["1860 233 1234", "+91 79 6586195"],
...
export default function ShipmentlinkTrackingPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/weeple-tracking" className="text-blue-600 underline">
              Weeple Logistics Courier
            </Link>
          </span>
        </p>
      </section>
