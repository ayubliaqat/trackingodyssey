// app/couriers/pioneer-express-logistics-tracking/page.tsx
...
const courier = {
  slug: "pioneer-express-logistics-tracking",
  name: "Pioneer Express Logistics",
  website: "https://pioneerexpress.co.in/",
  city: "Mumbai",
  address: "Dhobi Ghat, Parsiwada, Sahar Road, Next to Hari Kripa Bldg, Andheri(East), Mumbai-400 099, India",
  phone_numbers: ["+91 73035 95520", "+9004359520"],
  emails: ["mustafa@pioneerexpress.co.in", "pioneerexpress10@gmail.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Real-Time Parcel Updates`,
  description: `Track your shipment with ${courier.name} in Mumbai. Get instant delivery updates for your parcels online.`,
...
export default function PioneerExpressPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/janvi-logistics-tracking" className="text-blue-600 underline">
            Janvi Logistics Transport
          </Link>
        </p>
      </section>
