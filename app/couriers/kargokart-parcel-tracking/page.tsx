// app/couriers/kargokart-parcel-tracking/page.tsx
...
const courier = {
  slug: "kargokart-parcel-tracking",
  name: "KargoKart Parcel Service",
  website: "https://www.kargokart.in/",
  city: "Mumbai",
  address: "Mumbai, Maharashtra, India",
  phone_numbers: ["+91 937272 1901"],
  emails: ["info@kargokart.in"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Track Your Shipment`,
  description: `Track your shipment with KargoKart Parcel Service easily and get real-time updates.`,
...
// 🔹 Get other couriers dynamically for "Explore Other Couriers"
...
export default function KargoKartPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span>
            <Link href="/couriers/peachmode-order-tracking" className="text-blue-600 underline">Peachmode Order Delivery
</Link>
          </span>
        </p>
      </section>
