// app/couriers/ikea-order-tracking/page.tsx
...
const courier = {
  slug: "ikea-order-tracking",
  name: "IKEA Order Delivery",
  website: "https://www.ikea.com/in/en/",
  city: "New Delhi",
  address: "Unit No. 421, DLF Tower A, Jasola District Centre, New Delhi, South Delhi, DL IN 110044, India",
  phone_numbers: ["1800 419 4532"],
  emails: ["customercare.india@ikea.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Real-Time Parcel Updates`,
  description: `Track your IKEA orders easily with real-time updates on your shipment status.`,
  ...
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <header className="flex flex-col items-center mb-8 text-center">
        ...
        <p className="text-base sm:text-lg text-gray-700 mt-8">Enter your tracking number to check your shipment status online.</p>
      </header>
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/anand-bus-tracking" className="text-blue-600 underline">Anand Bus</Link>
        </p>
      </section>
