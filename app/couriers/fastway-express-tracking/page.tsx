// app/couriers/fastway-express-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "fastway-express-tracking",
  name: "Fastway Worldwide Express",
  website: "https://fastwayindia.com/",
  city: "Bangalore",
  address: "# 17/1, 1st Floor, Hosur Road, Richmond Town, Bangalore, 560025, Karnataka, India",
  phone_numbers: ["+91 93414 22222"],
  emails: ["support@fastwayindia.com"],
  logo: "", // optional
};
...
export default function FastwayExpressPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/sarveshwar-container-tracking" className="text-blue-600 underline">
              Sarveshwar Container Transport
            </Link>
          </span>
        </p>
      </section>
