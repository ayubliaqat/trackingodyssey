// app/couriers/sampark-logistics-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "sampark-logistics-tracking",
  name: "Sampark Global Logistics",
  website: "https://samparkglobal.com/",
  city: "Faridabad",
  address: "Sampark Global Bhawan, SCO-1523, Block-A, Green Fields, Faridabad, Haryana 121010, India",
  phone_numbers: ["0129-4000870"],
  emails: ["info@samparkglobal.com"],
  logo: "", // optional
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Faridabad. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Faridabad, India.`,
...
export default function SamparkLogisticsPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/emaklum-courier-tracking" className="text-blue-600 underline">
              Emaklum Courier Transport
            </Link>
          </span>
