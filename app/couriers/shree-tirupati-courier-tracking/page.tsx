// app/couriers/shree-tirupati-courier-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "shree-tirupati-courier-tracking",
  name: "Shree Tirupati Courier",
  website: "http://www.shreetirupaticourier.net/",
  city: "Rajkot",
  address: "G/F, Circle Court, DR. NR. YAGNIK ROAD, Ramakrishna Ashram, Rajkot, Gujarat, India",
  phone_numbers: ["0281-2460515"],
  emails: ["shreetcs@hotmail.com"],
  logo: "", // optional
};

// 🔹 Metadata
export const metadata: Metadata = {
  title: `${courier.name} Tracking - Parcel Status & Delivery Updates`,
  description: `Track your shipment with ${courier.name} in Rajkot. Get real-time updates and delivery information for your parcels.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Rajkot.`,
...
export default function ShreeTirupatiPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/mspdcl-tracking" className="text-blue-600 underline">
            MSPDCL Bill Online Check Status
          </Link>
        </p>
      </section>
