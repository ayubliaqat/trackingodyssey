// app/couriers/fedex-tracking/page.tsx
...
const courier = {
  slug: "fedex-tracking",
  name: "FedEx India",
  website: "https://www.fedex.com/en-in/home.html",
  city: "Mumbai",
  address: "Mumbai, Maharashtra, India",
  phone_numbers: ["1800-22-6161"],
  emails: ["india@fedex.com"],
  logo: "", // optional
};
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/avakaaya-courier-tracking" className="text-blue-600 underline">
              Avakaaya Courier Shipment
            </Link>
          </span>
