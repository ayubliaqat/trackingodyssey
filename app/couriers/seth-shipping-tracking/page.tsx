// app/couriers/seth-shipping-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "seth-shipping-tracking",
  name: "Seth Shipping Container",
  website: "https://www.sethshipping.com/",
  city: "Victoria Mahe",
  address: "1st Floor Allied Plaza, Francis Rachel Street P.O. Box 1289, Victoria MAHE, SEYCHELLES",
  phone_numbers: [],
  emails: ["sethenquiry@sethshipping.com"],
  logo: "", // optional
};
...
export default function SethShippingPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/bright-parcel-tracking" className="text-blue-600 underline">
              Bright Parcel Courier
            </Link>
          </span>
