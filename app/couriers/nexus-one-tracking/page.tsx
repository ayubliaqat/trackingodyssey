// app/couriers/nexus-one-tracking/page.tsx
...
const courier = {
  ...
  name: "Nexus One Courier",
  website: "https://nexusoneindia.in/",
  city: "Bangalore",
...
export const metadata: Metadata = {
  ...
  description: `Track your shipments with ${courier.name} in Bangalore and across India. Get real-time delivery updates by entering your tracking number.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Track your shipments with ${courier.name} in Bangalore and across India.`,
...
export default function NexusOnePage() {
  return (
