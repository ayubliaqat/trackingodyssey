// app/couriers/sri-renganathan-service-tracking/page.tsx
...
const courier = {
  slug: "sri-renganathan-service-tracking",
  name: "Sri Renganathan Motor Service",
  website: "https://www.renganathan.in/",
  city: "Trichy",
  address: "8, Nirmala Building, Fort Station Road, Trichy-2",
  phone_numbers: ["9385578039", "9488563928"],
  emails: ["info@renganathan.in"],
  logo: "",
};
...
export default function SriRenganathanPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/nippon-express-tracking" className="text-blue-600 underline">
