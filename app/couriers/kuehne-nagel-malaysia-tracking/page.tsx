// app/couriers/kuehne-nagel-malaysia-tracking/page.tsx
...
const courier = {
  slug: "kuehne-nagel-malaysia-tracking",
  name: "Kuehne Nagel Malaysia Courier",
  website: "https://mykn.kuehne-nagel.com/public-tracking/",
  city: "Johor",
  address: "Jalan Molek 3/20 No 49-02 & 51-02, 81100 Johor Bahru, MALAYSIA",
  phone_numbers: ["+60-07-361-9100"],
  emails: ["info.johorbahru@kuehne-nagel.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Real-Time Parcel Updates`,
  description: `Track your shipment with ${courier.name} in Johor. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Johor, Malaysia.`,
...
export default function KuehneNagelMalaysiaPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/sagawa-courier-tracking" className="text-blue-600 underline">
