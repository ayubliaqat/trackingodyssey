// app/couriers/safexpress-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "safexpress-tracking",
  name: "Safexpress Courier Transport",
  website: "http://www.safexpress.com/",
  city: "Gurugram",
  address: "28, Sector 18, Udyog Vihar, Gurugram-122015, India",
  phone_numbers: ["+911800113113"],
  emails: ["info@safexpress.com"],
  logo: "", // optional
};
...
export default function SafexpressPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/yes-first-to-5g-tracking" className="text-blue-600 underline">
              Yes First To 5G
            </Link>
          </span>
