// app/couriers/peachmode-order-tracking/page.tsx
...
const courier = {
  slug: "peachmode-order-tracking",
  name: "Peachmode Order Delivery",
  website: "https://peachmode.com/en-eu",
  city: "Mumbai",
  address: "Grand Central, Plot Bearing No. R-1, Sector 40, Nerul, Seawoods Railway Station, Seawoods, Floor 2, Unit No. S08, Mumbai, Maharashtra, 400706, India",
  phone_numbers: ["+91 22 6276 0606"],
  emails: ["contact@peachmode.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Track Your Shipment`,
  description: `Track your shipment with Peachmode Order Delivery easily and get real-time updates.`,
...
// 🔹 Get other couriers dynamically
...
export default function PeachmodePage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span>
            <Link href="/couriers/m5c-logistics-tracking" className="text-blue-600 underline">M5C Logistics Solution</Link>
          </span>
        </p>
      </section>
