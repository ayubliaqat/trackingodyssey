// app/couriers/weeple-tracking/page.tsx
...
const courier = {
  slug: "weeple-tracking",
  name: "Weeple Logistics Courier",
  website: "https://www.weeple.in/",
  city: "Indore",
  address: "Behind Gillu Da Punjabi Dhaba, Chandu Compound, Dewas Naka, Indore, India",
  phone_numbers: ["+91 8871249766", "+91 8871226766"],
  emails: ["Growth@weeple.in"],
  logo: "",
};
...
export default function WeepleTrackingPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/fastway-express-tracking" className="text-blue-600 underline">Fastway Worldwide Express</Link>
        </p>
      </section>
