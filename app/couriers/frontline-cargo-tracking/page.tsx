// app/couriers/frontline-cargo-tracking/page.tsx
...
const courier = {
  slug: "frontline-cargo-tracking",
  name: "Frontline Courier Cargo",
  website: "https://frontlinecourier.com/",
  city: "Chennai",
  address: "No 75, Chota Plaza Complex, Mounaswamy Mada Street, Ambattur O.T, Chennai, Tamil Nadu – 600053, India",
  phone_numbers: ["+91 8144111180","+91 9941302000","+91 9941312000"],
  emails: ["contact@frontlinecourier.com"],
  logo: "",
};
...
export default function FrontlineCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/fedex-tracking" className="text-blue-600 underline">
            FedEx India
          </Link>
        </p>
      </section>
