// app/couriers/nippon-express-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "nippon-express-tracking",
  name: "Nippon Express Group",
  website: "https://www.nipponexpress.com/",
  city: "Gurugram",
  address: "Unit No. 301, 3rd Floor, Welldone Tech Park, Sohna Road, Sector-48, Gurugram, Haryana-122018, India",
  phone_numbers: ["+91-124-4630900"],
  emails: [],
  logo: "",
};
...
export default function NipponExpressPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/star-door-to-door-tracking" className="text-blue-600 underline">
            Star Door To Door Courier
          </Link>
        </p>
      </section>
