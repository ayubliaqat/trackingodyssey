// app/couriers/scorpion-express-tracking/page.tsx
...
const courier = {
  slug: "scorpion-express-tracking",
  name: "Scorpion Express Courier",
  website: "https://scorpiongroup.in/",
  city: "Mumbai",
  address: "Dr. 610 of the Shah & Nahar Industrial Estate, E. Moses Road, Worli, Mumbai, IN – 400018, India",
  phone_numbers: ["+91 22 2497 8815", "+91 22 2497 8816", "+91 22 2497 8817"],
  emails: ["info@scorpiongroup.in"],
  logo: "",
};
...
export default function ScorpionTrackingPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/holisol-tracking" className="text-blue-600 underline">
            Holisol Logistics
          </Link>
        </p>
      </section>
