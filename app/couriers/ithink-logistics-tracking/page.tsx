// app/couriers/ithink-logistics-tracking/page.tsx
...
const courier = {
  slug: "ithink-logistics-tracking",
  name: "iThink Logistics Courier",
  website: "https://www.ithinklogistics.com/",
  city: "Mumbai",
  address: "101, First Floor, Gaurav Palace, Kandivali (West), Mumbai-400067, Maharashtra, Across from Bal Bharti College",
  phone_numbers: ["+09594620873"],
  emails: ["sales@ithinklogistics.com", "support@ithinklogistics.com"],
  logo: "",
};
...
export default function IThinkLogisticsPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/overseas-logistics-tracking" className="text-blue-600 underline">
            Overseas Express Logistics
          </Link>
        </p>
      </section>
        ...
        <table className="min-w-full border border-gray-300 text-sm">
          <tbody>
            ...
            <tr>
              ...
              <td className="px-4 py-2 break-words">{courier.emails.join(", ") || "N/A"}</td>
            </tr>
          </tbody>
        </table>
      </section>
