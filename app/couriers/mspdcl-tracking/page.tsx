// app/couriers/mspdcl-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "mspdcl-tracking",
  name: "MSPDCL Bill Online Check Status",
  website: "https://mspdcl.com/",
  city: "Imphal",
  address: "MSPDCL, 3rd Floor Secured Office Complex, North AOC, near 2nd MR Gate, Imphal, Manipur 795001",
  phone_numbers: ["1912"],
  emails: [],
  logo: "",
};
...
export const metadata: Metadata = {
  title: `${courier.name} Tracking - Bill Payment & Status`,
  description: `Check your MSPDCL bill status online with ${courier.name}. Get real-time updates for your electricity bill in Manipur.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your MSPDCL bill status online with ${courier.name} in Manipur.`,
...
export default function MSPDCLPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <header className="flex flex-col items-center mb-8 text-center">
        ...
        <p className="text-base sm:text-lg text-gray-700">
          Enter your bill number or consumer ID to check your status online.
        </p>
      </header>

      {/* Tracking Form */}
      <section aria-labelledby="tracking-form" className="text-center mb-10">
        <h2 id="tracking-form" className="sr-only">Check Your Bill Status</h2>
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/nexus-one-tracking" className="text-blue-600 underline">
            Nexus One Courier
          </Link>
        </p>
      </section>
