// app/couriers/airways-courier-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "airways-courier-tracking",
  name: "Airways Courier Delivery",
  website: "https://airwayscourier.co.in/",
  city: "Bangalore",
  address: "37/11, Airways house, 2nd cross, Meanee Avenue Road, Bangalore - 560042",
  phone_numbers: ["080-46525252"],
  emails: ["customercare@airwayscourier.co.In"],
  logo: "", // optional
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Bangalore. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Bangalore, India.`,
...
export default function AirwaysCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/first-flight-courier-tracking" className="text-blue-600 underline">
