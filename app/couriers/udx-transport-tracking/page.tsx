// app/couriers/udx-transport-tracking/page.tsx
...
const courier = {
  slug: "udx-transport-tracking",
  name: "UDX Worldwide Transport",
  website: "https://www.udxworldwide.com/",
  city: "Pune",
  address: "Shop No. 7, 408 Narayan Peth, Pune, Maharashtra 411030, India",
  phone_numbers: ["+91 (020) 41505555"],
  emails: ["cs@udx.in"],
  logo: "",
};
...
export default function UDXTransportPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/safexpress-tracking" className="text-blue-600 underline">Safexpress Courier Transport</Link>
        </p>
      </section>
