// app/couriers/arco-roadways-transport-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "arco-roadways-transport-tracking",
  name: "Arco Roadways Transport",
  website: "https://www.arcoroadways.com/",
  city: "Ahmedabad",
  address: "Lokhand Bazar, Sarangpur, Ahmedabad, Gujarat 380002",
  phone_numbers: ["07922140440","07922170340","07922112179"],
  emails: [],
  logo: "", // optional
};
...
export default function ArcoRoadwaysPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/ennore-cargo-tracking" className="text-blue-600 underline">
              Ennore Cargo Container Terminal
            </Link>
          </span>
