// app/couriers/jai-maharashtra-tracking/page.tsx
...
const courier = {
  slug: "jai-maharashtra-tracking",
  name: "Jai Maharashtra Cargo Movers",
  website: "https://www.jaimaharashtracargomovers.com/",
  city: "Delhi",
  address: "Kh. No. 101/19-22, Seeds Farm Road, Alipur, Delhi",
  phone_numbers: ["+91-9212705502", "9560885502"],
  emails: ["jaimaharashtracargomovers@gmail.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Real-Time Parcel Updates`,
  description: `Track your shipments with ${courier.name} in Delhi and across India. Get real-time delivery updates by entering your tracking number.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Track your shipments with ${courier.name} in Delhi and across India.`,
...
export default function JaiMaharashtraPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/nexus-one-tracking" className="text-blue-600 underline">Nexus One Courier</Link>
        </p>
      </section>
