// app/couriers/avakaaya-courier-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "avakaaya-courier-tracking",
  name: "Avakaaya Courier Shipment",
  website: "https://avakaaya.com/",
  city: "Hyderabad",
  address: "H.No. B-12A, D.No. 8-3-191/147/24, Madura Nagar, Hyderabad – 500 038, India",
  phone_numbers: ["+91 9246 832425"],
  emails: ["customercare@avakaaya.com"],
  logo: "", // optional
};
...
export default function AvakaayaCourierPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/ithink-logistics-tracking" className="text-blue-600 underline">
              iThink Logistics Courier
            </Link>
          </span>
