// app/couriers/star-door-to-door-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "star-door-to-door-tracking",
  name: "Star Door To Door Courier",
  website: "https://stardoortodoor.com/",
  city: "Ahmedabad",
  address: "SHREE KRISHNA CENTRE, G-77, ABOVE CROSS WORD, NR. MITHAKHALI SIX RD, NAVRANGPURA, AHMEDABAD, INDIA – 380009",
  phone_numbers: ["+07926402981","+919327077790"],
  emails: ["info@stardoortodoor.com"],
  logo: "",
};
...
export default function StarDoorCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link href="/couriers/gms-courier-tracking" className="text-blue-600 underline">
