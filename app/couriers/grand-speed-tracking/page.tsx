// app/couriers/grand-speed-tracking/page.tsx
...
const courier = {
  slug: "grand-speed-tracking",
  name: "Grand Speed Network",
  website: "https://grandspeednetwork.com/",
  city: "Mumbai",
  address: "Grand Speed Network Pvt Ltd, Shop no. 8, Ground Floor, Sahar Road, Sant Kabir Nagar, Chakala, Opp. Suba International Hotel, Andheri East, Mumbai – 400099, India",
  phone_numbers: ["022-49711253"],
  emails: ["info@grandspeednetwork.com"],
  logo: "",
};
...
export default function GrandSpeedPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/frontline-cargo-tracking" className="text-blue-600 underline">Frontline Courier Cargo</Link>
        </p>
      </section>
