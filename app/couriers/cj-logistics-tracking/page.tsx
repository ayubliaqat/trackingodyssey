// app/couriers/cj-logistics-tracking/page.tsx
...
const courier = {
  slug: "cj-logistics-tracking",
  name: "CJ Logistics Korea",
  website: "https://www.cjlogistics.com/en/",
  city: "Gurugram",
  address: "Darcl House, Plot No. 55P, Sector 44, Institutional Area, Gurugram, 122003 (HR), India",
  phone_numbers: ["090-1520-2121"],
  emails: ["yule.lee@cj.net"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Real-Time Parcel Updates`,
  description: `Track your shipment with ${courier.name} in Gurugram. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Gurugram, India.`,
...
export default function CJLogisticsPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/air-tanzania-tracking" className="text-blue-600 underline">
            Air Tanzania Cargo
          </Link>
        </p>
      </section>
