// app/couriers/oak-harbor-freight-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "oak-harbor-freight-tracking",
  name: "Oak Harbor Freight Line",
  website: "https://www.oakh.com/",
  city: "Auburn",
  address: "1339 West Valley Hwy North, PO Box 1469, Auburn, WA 98071-1469, USA",
  phone_numbers: ["+1 800-285-6254"],
  emails: ["CustSvc@oakh.com"],
  logo: "", // optional
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Auburn. Get real-time updates and delivery information for your parcels.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Auburn, USA.`,
    ...
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/shree-tirupati-courier-tracking" className="text-blue-600 underline">
