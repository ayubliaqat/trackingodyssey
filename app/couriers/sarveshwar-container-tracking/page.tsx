// app/couriers/sarveshwar-container-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "sarveshwar-container-tracking",
  name: "Sarveshwar Container Transport",
  website: "https://sarveshwar.in/",
  city: "Mumbai",
  address: "Warehousing Unit JNPT SEZ, Plot No E-3 & F-7, JNPT SEZ, Sector-7, JNPT Rd, Navi Mumbai, Maharashtra 400702, India",
  phone_numbers: ["+91 8999263140","+91 9320460204"],
  emails: ["ftwz@sarveshwar.in","mukesh.vastawat@sarveshwar.in"],
  logo: "", // optional
};
...
export default function SarveshwarContainerPage() {
  return (
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            ...
            <Link href="/couriers/seth-shipping-tracking" className="text-blue-600 underline">
              Seth Shipping Container
            </Link>
          </span>
