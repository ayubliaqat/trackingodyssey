// app/couriers/bright-parcel-tracking/page.tsx
...
const courier = {
  slug: "bright-parcel-tracking",
  name: "Bright Parcel Courier",
  website: "https://brightparcel.com/",
  city: "Rustampura",
  address: "Classic Corner Next to Ravantar Mandir, Near Hills Nursery, Rustampura, Surat-395002 (India)",
  phone_numbers: ["+91 982 555 9005"],
  emails: ["brightparcel.com@gmail.com"],
  logo: "",
};
...
export default function BrightParcelPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/arco-roadways-transport-tracking" className="text-blue-600 underline">
            Arco Roadways Transport Tracking
          </Link>
        </p>
      </section>
