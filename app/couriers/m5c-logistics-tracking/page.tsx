// app/couriers/m5c-logistics-tracking/page.tsx
...
const courier = {
  slug: "m5c-logistics-tracking",
  name: "M5C Logistics Solution",
  website: "https://m5clogs.com/",
  city: "New Delhi",
  address: "Khasra No 91 Bamnoli, Village Dwarka Sector 28, New Delhi, Delhi – 110061",
  phone_numbers: ["+91 011 471 11700"],
  emails: ["info@m5clogs.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Track Your Shipment`,
  description: `Track your shipment with M5C Logistics Solution easily and get real-time updates.`,
...
export default function M5CPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span>
            <Link href="/couriers/amway-order-tracking" className="text-blue-600 underline">AMWAY Order Delivery</Link>
          </span>
        </p>
      </section>
