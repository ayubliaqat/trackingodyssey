// app/couriers/amway-order-tracking/page.tsx
...
const courier = {
  slug: "amway-order-tracking",
  name: "AMWAY Order Delivery",
  website: "https://www.amway.in/",
  city: "New Delhi",
  address: "Ground Floor, Elegance Tower, Plot No. 8, Non Hierarchical Commercial Centre, Jasola, New Delhi-110025, India",
  phone_numbers: ["0124-4508888"],
  emails: ["care@amway.com"],
  logo: "",
};

export const metadata: Metadata = {
  title: `${courier.name} Tracking - Track Your Order Online`,
  description: `Track your AMWAY order delivery online with real-time updates.`,
...
// 🔹 Explore other couriers dynamically
...
export default function AmwayPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <span>
            <Link href="/couriers/pitney-bowes-tracking" className="text-blue-600 underline">Pitney Bowes Shipping</Link>
          </span>
        </p>
      </section>
