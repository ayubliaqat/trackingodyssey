// app/couriers/first-flight-courier-tracking/page.tsx
...
// 🔹 Static data
const courier = {
  slug: "first-flight-courier-tracking",
  name: "First Flight Courier",
  website: "https://www.firstflight.net/",
  city: "Mumbai",
  address: "G – 1001/02, 10th Floor, Lotus Corporate Park, Off Jay Coach Flyover, Western Express Highway, Goregaon (E), Mumbai – 400 063. INDIA",
  phone_numbers: ["02262686666"],
  emails: ["ffcl@www.firstflight.net"],
  logo: "", // optional
};
    ...
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
        ...
        <p className="text-gray-700">
          ...
          <Link href="/couriers/oak-harbor-freight-tracking" className="text-blue-600 underline">
            Oak Harbor Freight Line Tracking
          </Link>
        </p>
      </section>
