// app/couriers/abest-freight-logistics-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "abest-express-courier",
  name: "ABest Freight Logistics Cargo",
  website: "https://www.abestexpress.com/",
  city: "Pasig City",
  address: "Unit 301 Pacific Center Bldg., #33 San Miguel Ave., Ortigas Center, Pasig City",
  phone_numbers: ["(02) 661 7288", "(02) 723 0000"],
  emails: ["customer.relations@abestexpress.com"],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  description: `Track your shipment with ${courier.name} in Pasig City. Get instant delivery updates for your parcels online.`,
  alternates: { canonical: `https://trackingodyssey.com/couriers/${courier.slug}` },
  openGraph: {
    title: `${courier.name} Tracking`,
    description: `Check your parcel status online with ${courier.name} in Pasig City, Philippines.`,
...
export default function ABestFreightLogisticsPage() {
  return (
      ...
      {courier.website && (
        <section className="bg-gray-100 rounded-lg p-4 mb-10 text-sm sm:text-base" aria-label="Courier links">
          ...
          <p className="text-gray-700">
            ...
            <span className="mr-2">
              <Link href="/garuda-indonesia-cargo" className="text-blue-600 underline">
