// app/couriers/kgp-express-tracking/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "kgp-express-courier",
  name: "KGP Express Courier",
  website: "http://kgpdev.co.id/",
  city: "Jakarta",
  address:
    "Kantor Pusat Kerta Gaya Pusaka JL. AM. Sangaji NO. 15 B, Petojo, Gambir, Jakarta Pusat, DKI Jakarta 10130 – Indonesia",
  phone_numbers: ["021-63863857"],
  emails: ["info@kgp.co.id"],
  logo: "",
};
...
export default function KGPCourierPage() {
  return (
