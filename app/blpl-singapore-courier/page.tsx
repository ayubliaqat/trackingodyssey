// app/couriers/blpl-singapore-courier/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "blpl-singapore-courier",
  name: "BLPL Courier Delivery",
  website: "https://www.tgsblpl.com/index.html",
  city: "Singapore",
  address: "120 Lower Delta Road, #06-11 Cendex Centre, Singapore 169208.",
  phone_numbers: ["+65 6413 0561"],
  emails: ["info@tgsblpl.com"],
  logo: "",
};
...
export default function BLPLCourierDeliveryPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/postnord-portal-business"
              className="text-blue-600 underline"
            >
              Postnord Parcel Shipment
            </Link>
          </span>
        </p>
      </section>
