// app/couriers/valmo-tracking/page.tsx
...
const courier = {
  slug: "valmo-courier",
  name: "Valmo Courier Shipment",
  website: "https://www.valmo.in/",
  city: "Bangalore",
  address: "3rd Floor, Wing-E, Helios Business Park, Kadubeesanahalli Village, Varthur Hobli, Outer Ring Road Bellandur, Bangalore, Bangalore South, Karnataka, India, 560103",
  phone_numbers: [],
  emails: ["hello@valmo.in"],
  logo: "",
};
...
export default function ValmoPage() {
  return (
