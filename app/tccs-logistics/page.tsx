// app/couriers/tccs-logistics/page.tsx
...
const courier = {
  slug: "tccs-logistics",
  name: "TCCS Parcel Delivery",
  website: "https://www.tccs.in/",
  city: "Mumbai",
  address:
  ...
  phone_numbers: ["+91-22-6671 2097", "+91-22-6671 2099", "+91-22-6671 2298"],
  emails: ["info@tccs.in"],
  logo: "",
};
...
export default function TccsLogisticsPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/leopards-china-express"
              className="text-blue-600 underline"
            >
              Leopards China Express
            </Link>
          </span>
        </p>
      </section>
