...
// 🔹 Static courier data
const courier = {
  slug: "pickdel-express",
  name: "Pickdel Express Cargo",
  website: "https://pickdel.in/",
  city: "Cochin",
  address: "Palarivattom, Cochin",
  phone_numbers: ["9388615161", "9567311411"],
  emails: ["marketing@pickdel.in", "vivek@pickdel.in"],
  logo: "",
};
...
export default function PickdelExpressPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link href="/roadrunner-freight-courier" className="text-blue-600 underline">
              Roadrunner Freight Courier Delivery
            </Link>
          </span>
        </p>
      </section>
