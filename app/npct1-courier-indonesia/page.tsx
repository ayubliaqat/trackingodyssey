// app/couriers/npct1-courier-indonesia/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "npct1-courier-indonesia",
  name: "NPCT1 Courier Delivery",
  website: "https://www.npct1.co.id/",
  city: "Jakarta",
  address:
    "Jl. Terminal Kalibaru Raya Kav.B No.1, Cilincing Jakarta Utara, Daerah Khusus Ibukota Jakarta 14110, Indonesia",
  phone_numbers: ["+62 21 29144888"],
  emails: [],
  logo: "",
};
...
export default function NPCT1CourierIndonesiaPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/couriers/dohrn-transfer-company"
              className="text-blue-600 underline"
            >
              Dohrn Order Delivery
            </Link>
          </span>
        </p>
      </section>
