// app/couriers/doora-logistics-courier/page.tsx
...
// 🔹 Static courier data
const courier = {
  slug: "doora-logistics-courier",
  name: "Doora Logistics Courier",
  website: "https://www.doora.co.kr/",
  city: "Seoul",
  address:
    "DongHae Bldg, 54-7, Geumnanghwa-ro, Gangseo-gu, Seoul, Republic of Korea",
  phone_numbers: ["82-1588-4151"],
  emails: [],
  logo: "",
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `Check your parcel status online with ${courier.name} in Seoul, Republic of Korea.`,
...
export default function DooraLogisticsCourierPage() {
  return (
    <main className="px-4 sm:px-6 py-10 bg-white min-h-screen max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          <span className="mr-2">
            <Link
              href="/couriers/edi-express-courier"
              className="text-blue-600 underline"
            >
              EDI Express Courier
            </Link>
